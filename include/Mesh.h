...
public:
    ...
    Mesh(const float *vertices, size_t vertexSize, const unsigned int *indices, size_t indexSize, size_t vertexStride, const std::vector<std::tuple<unsigned int, size_t, int>> &attributeLayout);
